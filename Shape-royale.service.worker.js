...
const CACHE_VERSION = "1677983501|131729172594";
const CACHE_PREFIX = "Shape-Royale-sw-cache-";
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
const OFFLINE_URL = "Shape-royale.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Shape-royale.html","Shape-royale.js","Shape-royale.offline.html"];
// Files that we might not want the user to preload, and will only be cached on first load.
const CACHABLE_FILES = ["Shape-royale.wasm","Shape-royale.pck"];
